...
Source Server         : 120.27.29.158_3306
Source Server Version : 50621
Source Host           : 120.27.29.158:3306
Source Database       : lqbuluo

Target Server Type    : MYSQL
Target Server Version : 50621
File Encoding         : 65001

Date: 2016-08-18 14:03:09
*/
...
-- ----------------------------
INSERT INTO `onethink_action_log` VALUES ('1', '1', '1', '3031356950', 'member', '1', 'admin在2016-07-02 00:08登录了后台', '1', '1467389305');
INSERT INTO `onethink_action_log` VALUES ('2', '10', '1', '3031356950', 'Menu', '124', '操作url：/admin.php?s=/Menu/add.html', '1', '1467389606');
INSERT INTO `onethink_action_log` VALUES ('3', '10', '1', '3031356950', 'Menu', '124', '操作url：/admin.php?s=/Menu/edit.html', '1', '1467389627');
INSERT INTO `onethink_action_log` VALUES ('4', '10', '1', '3031356950', 'Menu', '125', '操作url：/admin.php?s=/Menu/add.html', '1', '1467389700');
INSERT INTO `onethink_action_log` VALUES ('5', '10', '1', '3031356950', 'Menu', '124', '操作url：/admin.php?s=/Menu/edit.html', '1', '1467389708');
INSERT INTO `onethink_action_log` VALUES ('6', '6', '1', '3031356950', 'config', '13', '操作url：/admin.php?s=/Config/edit.html', '1', '1467389808');
INSERT INTO `onethink_action_log` VALUES ('7', '6', '1', '3031356950', 'config', '13', '操作url：/admin.php?s=/Config/edit.html', '1', '1467389842');
INSERT INTO `onethink_action_log` VALUES ('8', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-02 08:50登录了后台', '1', '1467420646');
INSERT INTO `onethink_action_log` VALUES ('9', '10', '1', '1699866276', 'Menu', '126', '操作url：/admin.php?s=/Menu/add.html', '1', '1467426633');
INSERT INTO `onethink_action_log` VALUES ('10', '10', '1', '1699866276', 'Menu', '126', '操作url：/admin.php?s=/Menu/edit.html', '1', '1467426644');
INSERT INTO `onethink_action_log` VALUES ('11', '10', '1', '1699866276', 'Menu', '126', '操作url：/admin.php?s=/Menu/edit.html', '1', '1467426685');
INSERT INTO `onethink_action_log` VALUES ('12', '10', '1', '1699866276', 'Menu', '127', '操作url：/admin.php?s=/Menu/add.html', '1', '1467428311');
INSERT INTO `onethink_action_log` VALUES ('13', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-02 13:43登录了后台', '1', '1467438214');
INSERT INTO `onethink_action_log` VALUES ('14', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-02 13:45登录了后台', '1', '1467438303');
INSERT INTO `onethink_action_log` VALUES ('15', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-02 14:55登录了后台', '1', '1467442531');
INSERT INTO `onethink_action_log` VALUES ('16', '1', '1', '613778765', 'member', '1', 'admin在2016-07-02 22:06登录了后台', '1', '1467468411');
INSERT INTO `onethink_action_log` VALUES ('17', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-03 19:11登录了后台', '1', '1467544297');
INSERT INTO `onethink_action_log` VALUES ('18', '1', '1', '989235181', 'member', '1', 'admin在2016-07-04 13:37登录了后台', '1', '1467610623');
INSERT INTO `onethink_action_log` VALUES ('19', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-04 22:43登录了后台', '1', '1467643433');
INSERT INTO `onethink_action_log` VALUES ('20', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-05 06:26登录了后台', '1', '1467671176');
INSERT INTO `onethink_action_log` VALUES ('21', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-05 11:01登录了后台', '1', '1467687687');
INSERT INTO `onethink_action_log` VALUES ('22', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-05 12:52登录了后台', '1', '1467694356');
INSERT INTO `onethink_action_log` VALUES ('23', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-05 21:15登录了后台', '1', '1467724505');
INSERT INTO `onethink_action_log` VALUES ('24', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-06 06:40登录了后台', '1', '1467758440');
INSERT INTO `onethink_action_log` VALUES ('25', '1', '1', '3662596839', 'member', '1', 'admin在2016-07-06 07:13登录了后台', '1', '1467760420');
INSERT INTO `onethink_action_log` VALUES ('26', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-06 09:09登录了后台', '1', '1467767340');
INSERT INTO `onethink_action_log` VALUES ('27', '10', '1', '1699866276', 'Menu', '128', '操作url：/admin.php?s=/Menu/add.html', '1', '1467770458');
INSERT INTO `onethink_action_log` VALUES ('28', '1', '1', '3082907923', 'member', '1', 'admin在2016-07-06 15:41登录了后台', '1', '1467790889');
INSERT INTO `onethink_action_log` VALUES ('29', '1', '1', '3082907923', 'member', '1', 'admin在2016-07-07 09:24登录了后台', '1', '1467854679');
INSERT INTO `onethink_action_log` VALUES ('30', '1', '1', '3030172733', 'member', '1', 'admin在2016-07-19 23:49登录了后台', '1', '1468943362');
INSERT INTO `onethink_action_log` VALUES ('31', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-22 11:49登录了后台', '1', '1469159362');
INSERT INTO `onethink_action_log` VALUES ('32', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-23 11:46登录了后台', '1', '1469245598');
INSERT INTO `onethink_action_log` VALUES ('33', '1', '1', '1699866276', 'member', '1', 'admin在2016-07-24 11:53登录了后台', '1', '1469332430');
INSERT INTO `onethink_action_log` VALUES ('34', '1', '1', '1699865867', 'member', '1', 'admin在2016-08-05 13:43登录了后台', '1', '1470375800');
INSERT INTO `onethink_action_log` VALUES ('35', '1', '1', '1699865867', 'member', '1', 'admin在2016-08-05 15:48登录了后台', '1', '1470383300');
INSERT INTO `onethink_action_log` VALUES ('36', '1', '1', '3083777269', 'member', '1', 'admin在2016-08-05 20:34登录了后台', '1', '1470400447');
INSERT INTO `onethink_action_log` VALUES ('37', '1', '1', '613746352', 'member', '1', 'admin在2016-08-05 22:39登录了后台', '1', '1470407956');
INSERT INTO `onethink_action_log` VALUES ('38', '10', '1', '1699865867', 'Menu', '129', '操作url：/admin.php?s=/Menu/add.html', '1', '1470454844');
INSERT INTO `onethink_action_log` VALUES ('39', '10', '1', '1699865867', 'Menu', '129', '操作url：/admin.php?s=/Menu/edit.html', '1', '1470454859');
INSERT INTO `onethink_action_log` VALUES ('40', '10', '1', '1699865867', 'Menu', '129', '操作url：/admin.php?s=/Menu/edit.html', '1', '1470455664');
INSERT INTO `onethink_action_log` VALUES ('41', '10', '1', '1699865867', 'Menu', '130', '操作url：/admin.php?s=/Menu/add.html', '1', '1470470656');
INSERT INTO `onethink_action_log` VALUES ('42', '10', '1', '1699865867', 'Menu', '131', '操作url：/admin.php?s=/Menu/add.html', '1', '1470471135');
INSERT INTO `onethink_action_log` VALUES ('43', '10', '1', '1699865867', 'Menu', '131', '操作url：/admin.php?s=/Menu/edit.html', '1', '1470471325');
INSERT INTO `onethink_action_log` VALUES ('44', '1', '1', '1960895643', 'member', '1', 'admin在2016-08-06 22:07登录了后台', '1', '1470492440');
INSERT INTO `onethink_action_log` VALUES ('45', '1', '1', '1960895643', 'member', '1', 'admin在2016-08-07 07:49登录了后台', '1', '1470527364');
INSERT INTO `onethink_action_log` VALUES ('46', '6', '1', '1883250343', 'config', '39', '操作url：/admin.php?s=/Config/edit.html', '1', '1470559644');
INSERT INTO `onethink_action_log` VALUES ('47', '1', '1', '1960895643', 'member', '1', 'admin在2016-08-07 23:58登录了后台', '1', '1470585532');
INSERT INTO `onethink_action_log` VALUES ('48', '10', '1', '1960895643', 'Menu', '132', '操作url：/admin.php?s=/Menu/add.html', '1', '1470587356');
INSERT INTO `onethink_action_log` VALUES ('49', '1', '1', '1699865867', 'member', '1', 'admin在2016-08-08 10:10登录了后台', '1', '1470622201');
INSERT INTO `onethink_action_log` VALUES ('50', '1', '1', '1699865867', 'member', '1', 'admin在2016-08-09 09:35登录了后台', '1', '1470706508');
INSERT INTO `onethink_action_log` VALUES ('51', '1', '1', '1699865867', 'member', '1', 'admin在2016-08-13 09:15登录了后台', '1', '1471050908');
INSERT INTO `onethink_action_log` VALUES ('52', '10', '1', '1699865867', 'Menu', '133', '操作url：/admin.php?s=/Menu/add.html', '1', '1471052162');
INSERT INTO `onethink_action_log` VALUES ('53', '6', '1', '1699865867', 'config', '40', '操作url：/admin.php?s=/Config/edit.html', '1', '1471054091');
INSERT INTO `onethink_action_log` VALUES ('54', '1', '1', '1883250343', 'member', '1', 'admin在2016-08-13 13:38登录了后台', '1', '1471066705');
INSERT INTO `onethink_action_log` VALUES ('55', '10', '1', '1883250343', 'Menu', '133', '操作url：/admin.php?s=/Menu/edit.html', '1', '1471066965');
INSERT INTO `onethink_action_log` VALUES ('56', '10', '1', '1883250343', 'Menu', '134', '操作url：/admin.php?s=/Menu/add.html', '1', '1471068385');
INSERT INTO `onethink_action_log` VALUES ('57', '10', '1', '1883250343', 'Menu', '133', '操作url：/admin.php?s=/Menu/edit.html', '1', '1471068407');
INSERT INTO `onethink_action_log` VALUES ('58', '10', '1', '1883250343', 'Menu', '135', '操作url：/admin.php?s=/Menu/add.html', '1', '1471072677');
INSERT INTO `onethink_action_log` VALUES ('59', '10', '1', '1883250343', 'Menu', '135', '操作url：/admin.php?s=/Menu/edit.html', '1', '1471075082');
INSERT INTO `onethink_action_log` VALUES ('60', '10', '1', '1883250343', 'Menu', '136', '操作url：/admin.php?s=/Menu/add.html', '1', '1471075105');
INSERT INTO `onethink_action_log` VALUES ('61', '10', '1', '1883250343', 'Menu', '135', '操作url：/admin.php?s=/Menu/edit.html', '1', '1471075119');
INSERT INTO `onethink_action_log` VALUES ('62', '1', '1', '1883250343', 'member', '1', 'admin在2016-08-14 09:44登录了后台', '1', '1471139047');
...
-- ----------------------------
-- Table structure for `onethink_auction_data`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_auction_data`;
CREATE TABLE `onethink_auction_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `auction_type` tinyint(4) DEFAULT '0',
  `consume` smallint(4) DEFAULT NULL,
...
-- ----------------------------
-- Records of onethink_auction_data
-- ----------------------------
INSERT INTO `onethink_auction_data` VALUES ('33', '0', '2', '12', '45', '1', '1471165179');
INSERT INTO `onethink_auction_data` VALUES ('34', '0', '2', '12', '45', '2', '1471165179');
INSERT INTO `onethink_auction_data` VALUES ('37', '0', '2', '12', '45', '3', '1471170071');
INSERT INTO `onethink_auction_data` VALUES ('38', '0', '2', '12', '45', '5', '1471170211');
INSERT INTO `onethink_auction_data` VALUES ('39', '0', '2', '12', '45', '9', '1471170211');
INSERT INTO `onethink_auction_data` VALUES ('40', '0', '2', '12', '45', '7', '1471170354');
INSERT INTO `onethink_auction_data` VALUES ('41', '0', '2', '12', '45', '6', '1471185089');
INSERT INTO `onethink_auction_data` VALUES ('42', '0', '2', '12', '45', '8', '1471214832');
INSERT INTO `onethink_auction_data` VALUES ('43', '0', '2', '12', '45', '28', '1471215114');
INSERT INTO `onethink_auction_data` VALUES ('44', '0', '2', '12', '45', '33', '1471215114');
INSERT INTO `onethink_auction_data` VALUES ('45', '0', '2', '12', '45', '88', '1471224203');
INSERT INTO `onethink_auction_data` VALUES ('46', '0', '2', '12', '45', '55', '1471224316');
INSERT INTO `onethink_auction_data` VALUES ('47', '0', '2', '12', '46', '1', '1471224445');
INSERT INTO `onethink_auction_data` VALUES ('48', '0', '2', '12', '46', '2', '1471224445');
INSERT INTO `onethink_auction_data` VALUES ('49', '0', '2', '12', '46', '3', '1471224466');
INSERT INTO `onethink_auction_data` VALUES ('50', '0', '2', '12', '46', '5', '1471224466');
...
INSERT INTO `onethink_auth_rule` VALUES ('219', 'admin', '1', 'Admin/WeixinMenu/index', '微信菜单', '1', '');
INSERT INTO `onethink_auth_rule` VALUES ('220', 'admin', '1', 'Admin/WeixinMenu/edit', '增加菜单', '1', '');
INSERT INTO `onethink_auth_rule` VALUES ('221', 'admin', '2', 'Admin/WeixinMenu/index', '运营', '1', '');
...
-- ----------------------------
-- Table structure for `onethink_category_attribute`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_category_attribute`;
CREATE TABLE `onethink_category_attribute` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '属性ID',
  `category_id` int(11) unsigned DEFAULT NULL COMMENT '模型ID',
  ...
  PRIMARY KEY (`id`),
  KEY `category_id` (`category_id`,`search`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='属性表';

-- ----------------------------
-- Records of onethink_category_attribute
-- ----------------------------
...
INSERT INTO `onethink_config` VALUES ('38', 'GOODS_TYPE', '3', '商品类型', '0', '', '', '1470459610', '1470459610', '1', '0:销售\r\n1:竞拍', '0');
INSERT INTO `onethink_config` VALUES ('39', 'AUCTION_TYPE', '3', '竞拍类型', '0', '', '', '1470559254', '1470559644', '1', '0:米粒\r\n1:金币', '0');
INSERT INTO `onethink_config` VALUES ('40', 'GOODS_GROUP_LIST', '3', '商品信息分组', '0', '', '', '1471054031', '1471054091', '1', '1:商品信息\r\n2:描述\r\n', '0');
...
-- ----------------------------
INSERT INTO `onethink_document` VALUES ('1', '1', '', 'OneThink1.1开发版发布', '2', '0', '期待已久的OneThink最新版发布', '0', '0', '2', '2', '0', '0', '1', '1', '0', '0', '9', '0', '0', '0', '1406001360', '1467786181', '1');
...
CREATE TABLE `onethink_goods` (
  ...
  `goods_type` tinyint(4) unsigned DEFAULT '0' COMMENT '商品类型 0、销售 1、竞拍',
  `goods_name` varchar(100) DEFAULT '' COMMENT '商品名称',
  `brand_id` int(10) unsigned DEFAULT '0',
  `category_id` int(10) DEFAULT NULL,
  `shop_price` double(10,2) DEFAULT '0.00' COMMENT '商店售价',
  `cover` varchar(255) DEFAULT NULL COMMENT '商品封面',
  `status` tinyint(3) DEFAULT '0' COMMENT '状态',
  `update_time` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `create_time` int(10) unsigned DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='链接表';

-- ----------------------------
-- Records of onethink_goods
-- ----------------------------
INSERT INTO `onethink_goods` VALUES ('12', '1', 'Skullcandy smokin buds 2 入耳耳机 椭圆耳塞，防水mic，低音环绕音效。', null, null, '159.00', '2016-08-08/57a7f5c36541a.png', '1', '1471143575', '1470609621');
INSERT INTO `onethink_goods` VALUES ('13', '1', 'Skullcandy smokin buds 2 入耳耳机 椭圆耳塞，防水mic，低音环绕音效。', '0', null, '159.00', '2016-08-08/57a7f5c36541a.png', '1', '1471057676', '1471057676');
INSERT INTO `onethink_goods` VALUES ('14', '1', '1Skullcandy smokin buds 2 入耳耳机 椭圆耳塞，防水mic，低音环绕音效。', '0', null, '159.00', '2016-08-08/57a7f5c36541a.png', '1', '1471057701', '1471057701');
INSERT INTO `onethink_goods` VALUES ('15', '1', '1Skullcandy smokin buds 2 入耳耳机 椭圆耳塞，防水mic，低音环绕音效。', '0', null, '159.00', '2016-08-08/57a7f5c36541a.png', '1', '1471079618', '1471057714');

-- ----------------------------
-- Table structure for `onethink_goods_auction`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_goods_auction`;
CREATE TABLE `onethink_goods_auction` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '链接唯一标识',
  `goods_id` int(10) unsigned DEFAULT NULL,
  `auction_type` tinyint(4) DEFAULT '0',
  `consume` smallint(4) DEFAULT NULL COMMENT '消耗',
  `total` int(5) DEFAULT NULL,
  `start_time` int(10) DEFAULT NULL,
  `end_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='链接表';

-- ----------------------------
-- Records of onethink_goods_auction
-- ----------------------------
INSERT INTO `onethink_goods_auction` VALUES ('20', '12', '0', '2', '2000', '1470017820', '1471145057');
INSERT INTO `onethink_goods_auction` VALUES ('21', '0', '0', '3', null, null, null);

-- ----------------------------
-- Table structure for `onethink_goods_category`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_goods_category`;
CREATE TABLE `onethink_goods_category` (
...
-- ----------------------------
-- Records of onethink_goods_category
-- ----------------------------
INSERT INTO `onethink_goods_category` VALUES ('1', '数码', null);

-- ----------------------------
-- Table structure for `onethink_goods_content`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_goods_content`;
CREATE TABLE `onethink_goods_content` (
  `goods_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
  `content` text NOT NULL COMMENT '文章内容',
  `template` varchar(100) NOT NULL DEFAULT '' COMMENT '详情页显示模板',
  `bookmark` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '收藏数',
...
-- ----------------------------
-- Records of onethink_goods_content
-- ----------------------------
INSERT INTO `onethink_goods_content` VALUES ('12', '0', '<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124395-57503.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124414-76394.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124431-83171.jpg\" /> \r\n</p>', '', '0');
INSERT INTO `onethink_goods_content` VALUES ('13', '0', '<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124395-57503.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124414-76394.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124431-83171.jpg\" /> \r\n</p>', '', '0');
INSERT INTO `onethink_goods_content` VALUES ('14', '0', '<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124395-57503.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124414-76394.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124431-83171.jpg\" /> \r\n</p>', '', '0');
INSERT INTO `onethink_goods_content` VALUES ('15', '0', '<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124395-57503.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124414-76394.jpg\" /> \r\n</p>\r\n<p>\r\n	<img src=\"http://storeimg.meizu.com/product/1458124431-83171.jpg\" /> \r\n</p>', '', '0');

-- ----------------------------
-- Table structure for `onethink_goods_gallery`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_goods_gallery`;
CREATE TABLE `onethink_goods_gallery` (
...
-- ----------------------------
-- Records of onethink_goods_gallery
-- ----------------------------
INSERT INTO `onethink_goods_gallery` VALUES ('66', '12', '2016-08-08/57a7efebd8d83.png');
INSERT INTO `onethink_goods_gallery` VALUES ('65', '12', '2016-08-08/57a7efec6f22c.png');
INSERT INTO `onethink_goods_gallery` VALUES ('64', '12', '2016-08-08/57a7efecc02f3.png');
INSERT INTO `onethink_goods_gallery` VALUES ('43', '13', '2016-08-08/57a7efecc02f3.png');
INSERT INTO `onethink_goods_gallery` VALUES ('44', '13', '2016-08-08/57a7efec6f22c.png');
INSERT INTO `onethink_goods_gallery` VALUES ('45', '13', '2016-08-08/57a7efebd8d83.png');
INSERT INTO `onethink_goods_gallery` VALUES ('46', '14', '2016-08-08/57a7efecc02f3.png');
INSERT INTO `onethink_goods_gallery` VALUES ('47', '14', '2016-08-08/57a7efec6f22c.png');
INSERT INTO `onethink_goods_gallery` VALUES ('48', '14', '2016-08-08/57a7efebd8d83.png');
INSERT INTO `onethink_goods_gallery` VALUES ('63', '15', '2016-08-08/57a7efebd8d83.png');
INSERT INTO `onethink_goods_gallery` VALUES ('62', '15', '2016-08-08/57a7efec6f22c.png');
INSERT INTO `onethink_goods_gallery` VALUES ('61', '15', '2016-08-08/57a7efecc02f3.png');
...
-- ----------------------------
INSERT INTO `onethink_member` VALUES ('1', 'admin', '0', '0000-00-00', '', '60', '35', '0', '1467342807', '1883250343', '1471139047', '1');
...
INSERT INTO `onethink_menu` VALUES ('124', '运营', '0', '8', 'WeixinMenu/index', '0', '', '', '0', '1');
INSERT INTO `onethink_menu` VALUES ('125', '微信菜单', '124', '0', 'WeixinMenu/index', '0', '', '微信菜单管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('126', '新增/编辑菜单', '125', '0', 'WeixinMenu/edit', '1', '', '微信菜单管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('127', '添加按钮详情', '125', '0', 'WeixinMenu/editItem', '1', '', '微信菜单管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('128', '二级菜单列表', '125', '0', 'WeixinMenu/itemList', '1', '', '', '0', '1');
INSERT INTO `onethink_menu` VALUES ('129', '商品管理', '0', '9', 'Shop/index', '0', '', '', '0', '1');
INSERT INTO `onethink_menu` VALUES ('130', '商品列表', '129', '0', 'Shop/index', '0', '', '商品管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('131', '新增删除编辑', '129', '0', 'Shop/edit', '1', '', '商品管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('132', '商品竞拍信息', '129', '0', 'Shop/auction', '1', '', '', '0', '1');
INSERT INTO `onethink_menu` VALUES ('133', '分类列表', '129', '0', 'GoodsCategory/index', '0', '', '分类管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('134', '编辑/添加', '133', '0', 'GoodsCategory/edit', '0', '', '分类管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('135', '扩展属性列表', '133', '0', 'GoodsCategory/attribute', '0', '', '分类管理', '0', '1');
INSERT INTO `onethink_menu` VALUES ('136', '添加属性', '133', '0', 'GoodsCategory/editAttr', '0', '', '分类管理', '0', '1');
...
-- ----------------------------
INSERT INTO `onethink_picture` VALUES ('1', '/Uploads/Picture/2016-07-06/577ca3c2a7550.png', '', '43634a13d5778e42c9506c63b84f6878', '98591cb10ade9e2b82596bb44c3ad4f4c146a769', '1', '1467786178');

-- ----------------------------
-- Table structure for `onethink_seo_rule`
-- ----------------------------
...
-- ----------------------------
-- Records of onethink_seo_rule
-- ----------------------------
INSERT INTO `onethink_seo_rule` VALUES ('29', '首页', 'Home', 'Index', 'index', '1', '标题', '标题', '标题', '0');
...
-- ----------------------------
INSERT INTO `onethink_ucenter_member` VALUES ('1', 'admin', '4953523c02b459712e75c345dc06457c', '531357117@qq.com', '', '1467342807', '2130706433', '1471139047', '1883250343', '1467342807', '1');
...
-- ----------------------------
-- Table structure for `onethink_weixin_account`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_weixin_account`;
CREATE TABLE `onethink_weixin_account` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `wid` int(10) DEFAULT '0',
  `mili` int(10) DEFAULT '0' COMMENT '米粒',
...
-- ----------------------------
-- Records of onethink_weixin_account
-- ----------------------------
INSERT INTO `onethink_weixin_account` VALUES ('38', '45', '15', '0', '1');
INSERT INTO `onethink_weixin_account` VALUES ('39', '46', '5', '0', '1');

-- ----------------------------
-- Table structure for `onethink_weixin_account_log`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_weixin_account_log`;
CREATE TABLE `onethink_weixin_account_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `wid` int(10) DEFAULT NULL,
  `log_type` tinyint(5) DEFAULT NULL,
...
-- ----------------------------
-- Records of onethink_weixin_account_log
-- ----------------------------
INSERT INTO `onethink_weixin_account_log` VALUES ('38', '45', '1', '1', '5', '第一次进入赠送', null);
INSERT INTO `onethink_weixin_account_log` VALUES ('39', '46', '1', '1', '5', '第一次进入赠送', null);

-- ----------------------------
-- Table structure for `onethink_weixin_member`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_weixin_member`;
CREATE TABLE `onethink_weixin_member` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of onethink_weixin_member
-- ----------------------------
INSERT INTO `onethink_weixin_member` VALUES ('45', 'oaCnPwtd8vcyujeMM-MJvv0SUDBQ', '潘迪峰', '1', 'zh_CN', '徐汇', '上海', '中国', 'http://wx.qlogo.cn/mmopen/0IoXqZCUznRKo1gN1FSWiaIRBcCq3KfAPvkJMmcEY1SgDp30xeDZ96YB929JgmkC8HcKEQPPc3mNiaUicVBqicUKOw/0', null, null, null, '0', '1471021119', '1');
INSERT INTO `onethink_weixin_member` VALUES ('46', 'oaCnPwmePIVnzrl4k2u842rxF__w', '起儿的小可爱', '2', 'zh_CN', '', '上海', '中国', 'http://wx.qlogo.cn/mmopen/J8u5xeMkMCJ4YN8eVCqtIRL9ZENfM8nCpr3icBaqM8NUvYrQ9UXeXTmtbbWPlOf9NPPk0fQ8tvMWJ1hwzzVrtPGmnDXFsKYWS/0', null, null, null, '0', '1471224383', '1');

-- ----------------------------
-- Table structure for `onethink_weixin_menu`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_weixin_menu`;
CREATE TABLE `onethink_weixin_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `menu_type` tinyint(4) DEFAULT NULL COMMENT '一级或者二级菜单',
...
-- ----------------------------
-- Records of onethink_weixin_menu
-- ----------------------------
INSERT INTO `onethink_weixin_menu` VALUES ('1', '1', '今日推荐', '1', '1');
INSERT INTO `onethink_weixin_menu` VALUES ('2', '1', '零钱部落', '2', '1');
INSERT INTO `onethink_weixin_menu` VALUES ('3', '1', '个人中心', '3', '1');

-- ----------------------------
-- Table structure for `onethink_weixin_menu_item`
-- ----------------------------
DROP TABLE IF EXISTS `onethink_weixin_menu_item`;
CREATE TABLE `onethink_weixin_menu_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `menu_type` tinyint(4) DEFAULT NULL,
  `pid` int(10) DEFAULT NULL COMMENT '一级或者二级菜单',
  `name` varchar(30) DEFAULT '' COMMENT '菜单标题',
  `key` varchar(50) DEFAULT NULL COMMENT 'click等点击类型必须 菜单KEY值，用于消息接口推送',
  `url` varchar(255) DEFAULT NULL COMMENT 'view类型必须 网页链接，用户点击菜单可打开链接，不超过1024字节',
  `sort` int(10) unsigned DEFAULT '0' COMMENT '排序（同级有效）',
  `media_id` varchar(30) DEFAULT NULL COMMENT 'media_id类型和view_limited类型必须 调用新增永久素材接口返回的合法media_id',
...
-- ----------------------------
-- Records of onethink_weixin_menu_item
-- ----------------------------
INSERT INTO `onethink_weixin_menu_item` VALUES ('1', '1', '1', '今日推荐', '', 'http://wudi.1bea.com/weixin/index/index.html', '0', null, 'view', '1');
INSERT INTO `onethink_weixin_menu_item` VALUES ('2', '1', '2', '零钱部落', '', 'http://wudi.1bea.com/weixin/index/validate.html', '0', null, 'view', '1');
INSERT INTO `onethink_weixin_menu_item` VALUES ('3', '1', '3', '个人中心', '', 'http://wudi.1bea.com/weixin/index/member.html', '0', null, 'view', '1');
